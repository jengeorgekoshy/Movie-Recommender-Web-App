...
happy.addEventListener("click", () => {
    getMovies(API_URL + "&with_genres=16,28,12")
})

sad.addEventListener("click", () => {
    getMovies(API_URL + "&with_genres=18")
})

romantic.addEventListener("click", () => {
    getMovies(API_URL + "&with_genres=10749")
})

fear.addEventListener("click", () => {
    getMovies(API_URL + "&with_genres=27")
})

anger.addEventListener("click", () => {
    getMovies(API_URL + "&with_genres=53,10752")
})
